...
class App extends Component {
  ...
  componentDidMount() {
    ...
    if (isAuthenticated() || checkAuthentication()) {
      this.getTopGames();
      this.setState({ logged: true, filtersDisplayed: true });
    }
  }
    ...
    return (
      <div>
        ...
        <header>
          ...
          {!this.state.logged ? (
            <button onClick={this.login} className="user__button" title="Authenticate to search streams">
        ...
        <main>
          {!this.state.logged && 
           <p>Please authenticate first to search streams</p>
          }
